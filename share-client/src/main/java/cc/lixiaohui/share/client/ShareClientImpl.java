...
public class ShareClientImpl extends AbstractShareClient {
	...
	@Proxy(service="UserService", procedure="register", params=
	...
	@Proxy(service="UserService", procedure="login", params=
		{@Param(index = 0, name = "username"), @Param(index = 1, name = "password")})
	@Override
	...
	@Proxy(service="UserService", procedure="logout")
	@Override
	...
	@Override
	public String getShares(String keyword, int orderColumn, int orderType, int start, int limit) throws ClientException {
		return null;
	}
	...
	@Proxy(service="ShareService", procedure="deleteShare", params={
			@Param(index = 0, name = "shareId")})
	@Override
	public String deleteShare(int shareId) throws ClientException {
		return null;
	}
	...
	@Override
	public String getCommentOfShare(int shareId, int start, int limit) throws ClientException {
		return null;
	}

	@Proxy(service="CommentService", procedure="getCommentOfUser", params={
			@Param(index = 0, name = "start"),
			@Param(index = 1, name = "limit")})
	@Override
	public String getCommentOfUser(int start, int limit) throws ClientException {
		return null;
	}
	...
	@Override
	public String deleteCommentOfUser(int commentId) throws ClientException {
		return null;
	}

	@Proxy(service="CommentService", procedure="commentUser", params={
			@Param(index = 0, name = "shareId"),
			@Param(index = 1, name = "content"),
			@Param(index = 2, name = "toUserId")})
	@Override
	public String commentUser(int shareId, String content, int toUserId) throws ClientException {
		return null;
	}

	@Proxy(service="CommentService", procedure="commentShare", params={
			@Param(index = 0, name = "shareId"),
			@Param(index = 1, name = "content")})
	@Override
	public String commentShare(int shareId, String content) throws ClientException {
		return null;
	}
